...
describe('conFusion App E2E Testing', function () {
    ...
    describe('menu 0 item', function () {
        ...
        it('should show the number of comments as', function () {
            expect(element.all(by.repeater('com in dish.comments')).count()).toEqual(5);
        });

        it('should show the first comment author as', function () {
            element(by.model('sort')).sendKeys('author');
            expect(element.all(by.repeater('com in dish.comments')).count()).toEqual(5);
            var author = element.all(by.repeater('com in dish.comments')).first().element(by.binding('com.author'));
